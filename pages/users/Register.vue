          ...
          <v-card flat>
            ...
            <v-toolbar color="transparent" flat>
              <v-toolbar-title>
                <h2 class="text--primary font-weight-black mt-5">
                  注册{{ forum.attributes.set_site.site_name }}
                </h2>
            ...
            <div class="registerFormActions">
              <p>
                注册代表您同意
                <a
                  href="https://app.clodra.com/policies/privacy.html"
                  target="_blank"
                  >隐私政策</a
                >
                和
                <a
                  href="https://app.clodra.com/policies/policy.html"
                  target="_blank"
                  >用户协议</a
                >
              </p>
  ...
  methods: {
    ...
    async register() {
      ...
      if (result) {
        ...
        await this.$swal("注册成功!", "现在可以前去登录您的账号!", "success");
