	...
	<div>
		...
		<v-container>
			<v-card tile flat>
				...
				<v-card-subtitle>我们为您列出最近上传的代码中包含的更新。仅为您提供参考，这是第三方的PC DESKTOP版本（将先作为Lite版本发布），暂时无法用于生产。您可以再Github上关注，以便第一时间知道是否可用于生产 {{githubUrl}}。我们所有的功能，将在9月15日前完成。部分需求计划但并不会再9月15日前完全完成（Lite RC），而是将剩余需求每周迭代。因为这部分需求并不影响使用。</v-card-subtitle>
			</v-card>
