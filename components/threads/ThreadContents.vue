<template>
  <div>
    ...
    <!--标签-->
    <div>
      <v-chip label outlined v-if="isSticky" class="mb-1" color="primary" small
        >置顶</v-chip
      >
      <v-chip label outlined v-if="isEssence" class="mb-1" color="pink" small
        >精华</v-chip
      >
...
export default {
  ...
  computed: {
    ...
    showTitle() {
      ...
      return !this.$_.isEmpty(thread.attributes.title);
    },
    /**
     * 是否是付费贴
     */
