...
#### 将这个项目用于开源社区，Light版本是不需要授权的，Pro版本个人学习等非商业用途是不需要付费购买源代码使用权的。Pro源码正版授权购买属于自愿原则（目的捐赠以获得持续的更新和使用指导建议，及维持演示站点服务器等费用）  

### 再次重申，你可以免费使用，你的付费用于捐赠，纯属自愿
授权原则为单个域名，根据网站备案类型区分，企业用户授权与个人用户授权价格不一致。  
原价： 个人授权 288 企业授权 588  (非Light Version 精简版)  
如您预定，我们将预计9月15日前交付可用于生产的RC Light版本  
如果使用有疑问欢迎添加微信： gentlevirs  
Pro版本还没有开发，与Light版本相比较，将会有更多的功能，模板上将会有拓展的布局供选择。
